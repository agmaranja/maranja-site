...
const Hero = () => {
  return (
    <section 
      id="inicio" 
      className="relative py-20 md:py-28 bg-maranja-beige overflow-hidden"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col md:flex-row items-center md:justify-between">
          <div className="w-full md:w-1/2 mb-10 md:mb-0 md:pr-8">
            ...
            <p className="text-lg md:text-xl text-maranja-darkblue/80 mb-10 max-w-lg">
        ...
        <div className="mt-20 text-center relative">
          <p className="text-sm uppercase tracking-wider text-maranja-darkblue/60 mb-8">
