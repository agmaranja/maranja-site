...
const Services = () => {
  ...
  const servicesList = [
    ...
    {
      id: 2,
      title: "Automação de Agendamentos 24h",
      description: "Chatbots inteligentes para marcação, remarcação e cancelamento de consultas. Integração com SMS, WhatsApp e e-mail.",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    {
      id: 4,
      title: "Pacote de Conteúdo para Redes com IA",
