...
const EnglishServices = () => {
  ...
  const servicesList = [{
    ...
    id: 4,
    title: "AI-Powered Social Media Content Package",
    description: "Regular creation of posts (images, captions, and hashtags), with engagement intelligence and adaptation by specialty (e.g., dermatology, cardiology).",
    icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
    ...
    id: 5,
    title: "Intelligent CRM and Follow-Up Management",
    ...
    id: 7,
    title: "Intelligent Local Traffic Package",
    ...
    id: 8,
    title: "Google Presence Optimization (Local SEO)",
    ...
    id: 9,
    title: "Integration with Medical Records and Existing Tools",
    description: "We connect marketing systems with software the clinic already uses (e.g., iClinic, Doctoralia, etc.) for greater efficiency.",
    icon: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
  ...
  return <section id="services" className="py-16 md:py-24 bg-maranja-cream">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10">
          {servicesList.map(service => <div key={service.id} className="perspective-1000">
              <motion.div className={`card-container relative w-full h-72 cursor-pointer`} onClick={() => handleCardFlip(service.id)} animate={{
            ...
            transformStyle: "preserve-3d"
                ...
                <div className={`absolute w-full h-full backface-hidden ${flippedCardId === service.id ? "opacity-0" : "opacity-100"} transition-opacity duration-300 rounded-lg border border-maranja-darkblue/10 bg-white/90 backdrop-blur-sm hover:shadow-md`} style={{
              backfaceVisibility: "hidden"
                ...
                <div className={`absolute w-full h-full backface-hidden ${flippedCardId === service.id ? "opacity-100" : "opacity-0"} transition-opacity duration-300 bg-maranja-darkblue text-white rounded-lg border border-maranja-darkblue/10 flex flex-col justify-center p-8`} style={{
              backfaceVisibility: "hidden",
              transform: "rotateY(180deg)"
                  ...
                  <p className="text-white/90 text-lg">
                    {service.id === 9 ? <>
                        We seamlessly integrate our digital marketing solutions with the systems your clinic already uses:
                        <ul className="list-disc pl-5 mt-3 space-y-2">
                          <li>Electronic medical records (iClinic, Doctoralia, etc)</li>
                          <li>Billing systems</li>
                          <li>Medical management software</li>
                          <li>Third-party APIs</li>
                        </ul>
                      </> : service.description}
                  </p>
                  <p className="mt-6 text-sm italic text-white/70">Click to go back</p>
                </div>
              </motion.div>
            </div>)}
        </div>
        ...
        <div className="mt-16">
          <Card className="bg-white/90 p-8 rounded-lg shadow-lg border border-maranja-darkblue/10 hover:shadow-xl transition-shadow">
            <div className="cursor-pointer" onClick={() => handleCardFlip(10)}>
              ...
              transformStyle: "preserve-3d"
                ...
                backfaceVisibility: "hidden"
                  ...
                  <p className="mt-6 text-sm text-center text-maranja-darkblue/60 font-medium">
                    Click to see detailed benefits
                  </p>
                </div>

                {/* Back of Card */}
                <div className={`absolute inset-0 backface-hidden ${flippedCardId === 10 ? "opacity-100" : "opacity-0"} transition-opacity duration-300 bg-maranja-darkblue text-white rounded-lg p-8`} style={{
                backfaceVisibility: "hidden",
                transform: "rotateY(180deg)"
              }}>
                  <h3 className="text-2xl font-bold mb-6 text-center">The Benefits of On-Demand Automation</h3>
                  
                  <div className="space-y-6">
                    <div>
                      <h4 className="text-xl font-semibold mb-2">Maximum Flexibility</h4>
                      <p>Our automation cards work like prepaid credits. Use them for any automation need within your clinic: appointment reminders, patient follow-ups, inventory management, or administrative tasks.</p>
                    </div>
                    
                    <div>
                      <h4 className="text-xl font-semibold mb-2">Cost-Effective Solution</h4>
                      <p>Instead of investing in multiple systems with monthly fees, our on-demand model allows you to pay only for the automation services you actually use, reducing your operational costs significantly.</p>
                    </div>
                    
                    <div>
                      <h4 className="text-xl font-semibold mb-2">Technical Support Included</h4>
                      <p>Each automation card includes priority technical support to ensure your automations run smoothly. Our team is always available to help you optimize your workflows.</p>
                    </div>
                  </div>
                  ...
                  <p className="mt-6 text-sm italic text-center text-white/70">Click to go back</p>
                </div>
              </motion.div>
            </div>
          </Card>
