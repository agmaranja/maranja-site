        ...
        <div className="mt-16">
          <Card className="bg-white/90 p-8 rounded-lg shadow-lg border border-maranja-darkblue/10 hover:shadow-xl transition-shadow">
            <div 
              ...
              onClick={() => handleCardFlip(10)}
            >
              <motion.div 
                className="card-container relative w-full"
                animate={{ rotateY: flippedCardId === 10 ? 180 : 0 }}
                transition={{ duration: 0.6 }}
                style={{ transformStyle: "preserve-3d" }}
              >
                {/* Front of Card */}
                ...
                >
                  <div className="flex flex-col md:flex-row items-center">
                    <div className="md:w-3/5 mb-6 md:mb-0 md:pr-8">
                      <h3 className="text-2xl md:text-3xl font-bold mb-4 text-maranja-darkblue">On-Demand Automation Card</h3>
                ...
                <div 
                  ...
                  } transition-opacity duration-300 bg-maranja-darkblue text-white rounded-lg p-8`}
                  style={{ 
                    backfaceVisibility: "hidden",
                    transform: "rotateY(180deg)",
                  }}
